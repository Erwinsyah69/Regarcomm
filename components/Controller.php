 ...
 *Author:Suresh Babu Kokkonda
 *Email:sureshbabu.kokkonda@gmail.com
 */
    ...
    public function setLanguage() {
        ...
        if (isset($_GET['lang'])) {
            if (sizeof($languages) > 0) {
                Yii::app()->session['language'] = $languages[$_GET['lang']]['id_language'];
                Yii::app()->session['languagecode'] = $languages[$_GET['lang']]['code'];
                Yii::app()->language = $languages[$_GET['lang']]['code'];
            }
        } else {
            if (Yii::app()->session['language'] == '' || Yii::app()->session['languagecode'] == '') {
                Yii::app()->session['language'] = $languages[Yii::app()->config->getData('CONFIG_STORE_DEFAULT_LANGUAGE')]['id_language'];
